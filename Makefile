...
MODULES=js_bindings asynchronous_computations math helper textures models main
...
models.cmo: math.cmo models.ml helper.cmo js_bindings.cmo textures.cmo
textures.cmo: textures.ml js_bindings.cmo
main.cmo: main.ml js_bindings.cmo models.cmo
